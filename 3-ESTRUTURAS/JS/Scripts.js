...
const nomecompleto = "Thalia Cirqueira";
...
// 7.if = Altera o fluxo de execução do código
const m = 10;
...
const userName = "Thalia";
const userAge = 31;

if (userName === "José") {
  console.log("Bem vindo José!");
} else if (userName === "Thalia" && userAge === 31) {
  console.log("Olá Thalia, você tem 26 anos!");
} else {
...
// 15.switch organização de um excsso de if/else
const job = "Advogado";
